...
LOCAL_RESULTS_DIR="${LOCAL_DIR_EXP}/RESULT_MADPOSE/result_madpose_Apartment_release_decoration_seq136_M1292"
LOCAL_RESULTS_DIR="${LOCAL_DIR_EXP}/RESULT_MADPOSE/result_madpose_Apartment_release_clean_seq133_M1292"
LOCAL_RESULTS_DIR="${LOCAL_DIR_EXP}/RESULT_MADPOSE/result_madpose_Apartment_release_clean_seq136_M1292"
LOCAL_RESULTS_DIR="${LOCAL_DIR_EXP}/RESULT_MADPOSE/result_madpose_Apartment_release_multiuser_cook_seq141_M1292_1"

#result_madpose_Apartment_release_decoration_seq136_M1292"
#result_madpose_Apartment_release_clean_seq133_M1292"
#result_madpose_Apartment_release_clean_seq136_M1292"
...
python visualise_check_clouds_adt.py \
    ...
    --img1 "${LOCAL_IMAGE_DIR}/image0.jpg" \
    --img2 "${LOCAL_IMAGE_DIR}/image1.jpg" \
